...
public class MusicUtil {
    ...
    public static void playFly() {
        try {
            ...
            InputStream flyIn = new FileInputStream("classpath:/wav/fly.wav");
    ...
    public static void playCrash() {
        try {
            // create an AudioStream from the InputStream
            InputStream crashIn = new FileInputStream("classpath:/wav/crash.wav");
    ...
    public static void playScore() {
        try {
            // create an AudioStream from the InputStream
            InputStream scoreIn = new FileInputStream("classpath:/wav/score.wav");
